	...
	<div id="content-left-in">
		...
		<div class="tasks">
			...
			<div class="nosmooth">
				<div class="descript">
					...
					{section name=comment loop=$comments}
						<div class="message-in">
							<strong>{$comments[comment].username|truncate:20:"...":true}</strong>&nbsp;&nbsp;({$comments[comment].postdate}):<br/>
				...
				<div class="descript">
					{*Add Reply*}
					<div id = "form_reply_a" class="addmenue" style = "display:block;">
						<div class="content-spacer"></div>
						{include file="commentform.tpl" showhtml="no" reply="b"}
					</div>
					<div class="content-spacer"></div>
				</div>
			</div>
